      ...
      {!started && (
        <section className="panel overflow-hidden" aria-labelledby="demo-start-title">
          <div className="grid md:grid-cols-[1.05fr_1fr]">
            <div className="relative flex flex-col overflow-hidden border-b border-line bg-canvas-2 p-8 sm:p-10 md:border-b-0 md:border-r"><div className="eyebrow">Walkthrough</div><h2 id="demo-start-title" className="display mt-5 max-w-sm text-[36px] leading-[1.05] sm:text-[40px]">One credential.<br /><span className="glow">Clear decisions.</span></h2><p className="mt-4 max-w-xs text-sm leading-6 text-fg-muted">Try a screening. Explore a credential. Compare access requirements.</p><div className="index mt-auto flex flex-wrap gap-x-6 gap-y-2 pt-10 text-fg-muted"><span className="inline-flex items-center gap-2.5"><span className="dot" />Sample identities</span><span className="inline-flex items-center gap-2.5"><span className="dot" />Testnet credential</span></div></div>
